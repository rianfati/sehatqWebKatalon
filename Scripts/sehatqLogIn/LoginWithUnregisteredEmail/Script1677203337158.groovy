...
WebUI.setText(findTestObject('Object Repository/sehatq/regEmail'), 'budiAnduk@mail.com')
...
WebUI.verifyElementNotPresent(findTestObject('Object Repository/sehatq/profileIcon'), 2)
