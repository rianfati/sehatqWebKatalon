...
WebUI.verifyElementPresent(findTestObject('Object Repository/sehatq/editProfileButton'), 2)
WebUI.click(findTestObject('Object Repository/sehatq/editProfileButton'))
WebUI.waitForElementPresent(findTestObject('Object Repository/sehatq/editProfileName'), 2)
Thread.sleep(3000)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/sehatq/alertNameRegister'), 2)
WebUI.verifyElementPresent(findTestObject('Object Repository/sehatq/alertHeightEmpty'), 2)
WebUI.verifyElementPresent(findTestObject('Object Repository/sehatq/alertWeightEmpty'), 2)
WebUI.verifyElementPresent(findTestObject('Object Repository/sehatq/alertAddressEmpty'), 2)
//WebUI.closeBrowser()
