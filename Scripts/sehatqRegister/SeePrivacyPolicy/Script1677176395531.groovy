...
WebUI.click(findTestObject('Object Repository/sehatq/regTncPrivacyPolicyLink'))
WebUI.verifyElementPresent(findTestObject('Object Repository/sehatq/privacyPolicyTitle'), 5)
