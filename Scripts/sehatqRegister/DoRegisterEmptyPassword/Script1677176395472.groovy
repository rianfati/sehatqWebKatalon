...
WebUI.setText(findTestObject('Object Repository/sehatq/regPassword'), '')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/sehatq/alertPasswordRegister'), 0)
