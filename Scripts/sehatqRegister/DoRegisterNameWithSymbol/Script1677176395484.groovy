...
WebUI.setText(findTestObject('Object Repository/sehatq/regName'), "Rifa'i")
...
WebUI.verifyElementPresent(findTestObject('Object Repository/sehatq/alertNameWithSymbol'), 0)
