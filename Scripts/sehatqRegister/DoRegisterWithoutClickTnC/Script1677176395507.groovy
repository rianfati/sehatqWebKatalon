...
WebUI.setText(findTestObject('Object Repository/sehatq/regEmail'), email)
...
//if (WebUI.verifyElementPresent(findTestObject('Object Repository/sehatq/VerificationMethodText'), 2, FailureHandling.OPTIONAL)){
//	WebUI.click(findTestObject('Object Repository/sehatq/regTncCheckBox'))
//}
WebUI.verifyElementNotPresent(findTestObject('Object Repository/sehatq/VerificationMethodText'), 2)
